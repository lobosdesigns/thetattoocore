...
- Dark-mode contrast must be checked on every modal, lightbox, admin page, and profile/account surface before app-store submission. Media lightbox and the admin overview shell have a launch fix for readable black/white contrast.
