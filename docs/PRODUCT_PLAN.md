...
- Merch rules should allow public fan purchases of safe brand goods while still requiring seller approval for artists, studios, vendors, and official TheTattooCore store inventory. Admin product approval/activation now checks seller license verification for non-official Merch before it can go public.
