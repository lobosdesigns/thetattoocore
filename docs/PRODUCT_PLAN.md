...
- Messages: integrated direct messenger for bookings, marketplace questions, and collaboration. Senders should be able to delete their own DM messages only while the other user has not read them; after read, use clear deletion/retention rules instead of silent removal. DM threads should show small delivered/read status icons under outgoing messages.
