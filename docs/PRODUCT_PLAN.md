...
- Column swipes should also reset the newly active column to the top and refresh against that column's newest ranked posts so a user lands at the current top of 4U, Gossip, Stuff, Gigs, Merch, or DM instead of staying mid-scroll from the previous column.
