...
- Owner/admin support tooling should eventually include a controlled way to create tester/member accounts from Admin for QA, demos, dummy marketplace data, and support workflows. This requires Supabase service-role/server-only auth access and should never expose raw passwords in the browser.
