...
- Admin sections must become dedicated pages as volume grows, especially Users, Ads, Stuff, Merch, Reports, Verification, Data Requests, Content, Gigs, Media Ops, and Mail Settings. Each long admin list should use real pagination instead of an endless dashboard section; Users, Ads, Data Requests, and Verification have started with 50-item page layers.
