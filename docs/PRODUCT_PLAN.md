...
- Gigs: jobs, conventions, guest spots, shop openings, apprenticeships, and event opportunities for artists and studios. Gig owners must be able to edit or delete/archive their own Gigs while preserving moderation history and notification safety. Started for launch with owner edit/archive controls on Gig detail pages, main-card manage entry points, and server checks that require an actual owned row.
