...
- Native checkout policy review must be dated and repeated for the exact build or release track before exposing checkout in iOS or Android wrappers. The July 20, 2026 review source set is Apple App Review Guidelines and Google Play Payments policy; re-check both before submission if the build, paid flows, or store rules change.
