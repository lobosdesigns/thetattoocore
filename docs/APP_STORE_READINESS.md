...
- Full verification on July 14, 2026 passed after polishing Account booking calendar-prep copy and public profile booking calendar status labels. Live deploy version `25562fb3-7697-4b8d-a323-817613bbde64` passed public route smoke and optional 390px mobile browser smoke after one transient post-deploy mobile retry.
