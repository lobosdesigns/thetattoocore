...
- Full verification on July 14, 2026 passed after hardening 4U/Gossip comment, reply, like, edit, delete, hide, and block actions so return redirects stay internal and revalidation strips query/hash fragments before refreshing. Live deploy version `47e1e696-aa81-46e3-af4e-a8e6828a7176` passed public route smoke and optional 390px mobile browser smoke.
