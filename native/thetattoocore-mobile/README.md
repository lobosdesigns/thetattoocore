...
| Checked-in replacement candidate | `36 / 36`; `5` / `1.0.4` | Requires a fresh signed rebuild plus real-device QA evidence before track selection; do not disturb active build 4 until this candidate passes. |
