...
| Staged Play candidate | `36 / 36`; candidate `4` / `1.0.3` | Signed bundle accepted and Alpha change sent for review; Google Play installation and exact-build real-device QA are still required before it replaces the active baseline. |
