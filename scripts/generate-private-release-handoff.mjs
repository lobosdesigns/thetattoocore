...
| Apple | App Review monitoring and response evidence | Confirm the current iOS App Version and selected build in App Store Connect; archive reviewer messages, status changes, rejection notes, or approval proof privately | pending | |
