...
const routes = [
  ...
  { expectedMainStatus: 200, path: "/u/ceocore/followers", textIncludes: ["CEOCore", "Followers", "Back to profile"] },
  { expectedMainStatus: 200, path: "/u/ceocore/following", textIncludes: ["CEOCore", "Following", "Back to profile"] },
