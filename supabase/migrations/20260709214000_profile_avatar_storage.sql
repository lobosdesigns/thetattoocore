...
drop policy if exists "Profile avatars are publicly readable"
  on storage.objects;
drop policy if exists "Users upload own profile avatars"
  on storage.objects;
drop policy if exists "Users update own profile avatars"
  on storage.objects;
drop policy if exists "Users delete own profile avatars"
  on storage.objects;
