...
const searchTermAliases: Record<string, readonly string[]> = {
  ...
  appointment: ["booking"],
  artists: ["artist", "tattooer", "tattooist"],
  artist: ["tattooer", "tattooist"],
  bookings: ["booking", "appointment"],
  comments: ["comment"],
  conventions: ["convention", "event", "gig"],
  convention: ["event", "gig"],
  dms: ["dm", "message"],
  events: ["event", "gig"],
  flash: ["tattoo", "art"],
  guestspot: ["guest", "spot", "gig"],
  guestspots: ["guest", "spot", "gig"],
  jobs: ["job", "gig"],
  messages: ["message", "dm"],
  prints: ["print", "art", "merch"],
  products: ["product", "merch"],
  sellers: ["seller", "vendor"],
  shirts: ["shirt", "apparel", "merch"],
  shop: ["studio"],
  shops: ["shop", "studio"],
  stickers: ["sticker", "merch"],
  studio: ["shop"],
  studios: ["studio", "shop"],
  tattoer: ["tattooer", "artist"],
  tattoers: ["tattooer", "artist"],
  tattooers: ["tattooer", "artist"],
  tattooists: ["tattooist", "artist"],
  tattoos: ["tattoo"],
  tshirts: ["shirt", "apparel", "merch"],
  tshirt: ["shirt", "apparel", "merch"],
  vendor: ["seller"],
      ...
      <div className="ttc-page-panel mx-auto min-h-screen w-full max-w-4xl overflow-x-hidden">
        ...
        <section className="px-4 py-5">
          ...
          <div className="ttc-surface mt-3 flex items-start gap-2 rounded-md border px-3 py-2 text-xs leading-5 text-[var(--muted-strong)]">
            ...
            <p>
              Merch checkout is limited right now. Search shows active,
