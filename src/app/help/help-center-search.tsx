...
const helpSearchAliases: Record<string, string[]> = {
  ...
  block: ["block", "blocked", "blocking", "unblock", "privacy", "safety", "report"],
  blocked: ["block", "blocked", "blocking", "unblock", "privacy", "safety", "report"],
  blocking: ["block", "blocked", "blocking", "unblock", "privacy", "safety", "report"],
  bank: ["bank", "payout", "payouts", "seller", "payment"],
  bookmark: ["bookmark", "bookmarks", "saved", "save", "favorite", "favorites"],
  bookmarks: ["bookmark", "bookmarks", "saved", "save", "favorite", "favorites"],
  ...
  caption: ["caption", "captions", "post", "posts", "comment", "comments", "reply", "replies"],
  captions: ["caption", "captions", "post", "posts", "comment", "comments", "reply", "replies"],
  ...
  favorite: ["favorite", "favorites", "saved", "save", "bookmark", "bookmarks"],
  favorites: ["favorite", "favorites", "saved", "save", "bookmark", "bookmarks"],
  ...
  harassment: ["harassment", "report", "block", "safety", "privacy", "support"],
  ...
  login: ["login", "sign in", "signin", "signup", "password", "reset", "email"],
  overflow: ["overflow", "layout", "mobile", "screen", "scroll", "beta"],
  password: ["password", "reset", "forgot", "login", "sign in", "email"],
  screenshot: ["screenshot", "screenshots", "clip", "clips", "bug", "report", "safe"],
  screenshots: ["screenshot", "screenshots", "clip", "clips", "bug", "report", "safe"],
  ...
  spam: ["spam", "harassment", "report", "block", "comment", "comments", "dm", "dms"],
